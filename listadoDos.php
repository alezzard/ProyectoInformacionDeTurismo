                ...
                <div class="card-body pb-0">
                  ...
                  <table class="table table-borderless">
                    ...
                    <?php                         
                        ...
                        <tr>
                            <!-- orden -->
                        <th scope="row"> <?php echo $producto['Orden'];?> </th>                   
                        <!-- imagen -->
                        <th><a href=#><img class="imagen" src="<?php echo $Productos[$i]['imagen'];?>" alt="Imagen del producto"></a></th>                                               
                        ...
                        <?php 
                          ...
                          <div class="progress mt-3">
                            <div class="progress-bar progress-bar-striped progress-bar-animated <?php echo $colorBarra; ?>"
                              role="progressbar" 
                              style="width: 20%"
                              ...
                              data-bs-original-title="Stock Actual: <?php echo $stockActual; ?> | Min.: <?php echo $stockMin; ?>" 
                              >
                            </div>                                                    
                          </div>
                        </td> 
                        ...
                        <td>
                          <h4>
                            <span class="badge border-danger border-1 <?php $colorTexto; ?>">
                              U$S <?php echo $producto['precio']; ?>
                             </span>
                          </h4>
                        </td>
                        <!-- votos -->
                        ...
                        <td>                            
                          ...
                          Total votos: <?php echo $producto['valoraciones']['positivas'] + $producto['valoraciones']['negativas']; ?>
                           <h5>                           
                                    
                            <span title="Votos: Positivos 70 y Negativos 30" 
                              class="badge border-info border-1 text-info">
                              <?php echo $producto['valoraciones']['positivas']; ?> %
                              <i class="bi bi-hand-thumbs-up-fill danger"></i>
                              |
                              <?php echo $producto['valoraciones']['negativas']; ?> %
                              <i class="bi bi-hand-thumbs-down-fill danger"></i>
                            </h5>
                        ...
                        <td>
                          <h3>
                            <span 
                              data-bs-placement="bottom"
                              data-bs-toggle="tooltip" 
                              data-bs-original-title='No se permite venta web'
                        ...
                        <td>
                          <h4>
                            <span class="badge border-info border-1 text-info">                            
                             U$S <?php echo $producto['monetario_en_stock']; ?>
                            </span>
                          </h4>
                        </td>
                      </tr>                                          
